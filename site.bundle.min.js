...
function getVisibleNavbar() {
  return [...document.querySelectorAll(".navbar")].find(isActuallyVisible) || null;
}

//Init visible navbar only
document.addEventListener("DOMContentLoaded", () => {
...
function initNavbarOverlapScroll(navbar) {
  ...
  function collapse() {
    if (isCollapsed || !isActuallyVisible(navbar)) return;
    isCollapsed = true;
...
function initTabbarDropdown(navbar) {
  ...
  if (!wrapper || !isActuallyVisible(wrapper)) return;
