...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function getPanelHeight(panel) {
    const wasActive = panel.classList.contains("is_active");
  ...
  function openMobilePanel(key) {
    ...
    if (oldPanel) {
      tl.to(oldPanel, {
        ...
        onComplete: () => {
          oldPanel.classList.remove("is_active");
          oldPanel.style.height = "";
          oldPanel.style.overflow = "";
        }
      }, 0);
    }
  ...
  function closeMobilePanel() {
    ...
    gsap.to(panelToClose, {
      ...
      onComplete: () => {
        panelToClose.classList.remove("is_active");
        panelToClose.style.height = "";
        panelToClose.style.overflow = "";
        currentPanel = null;
        activeKey = null;
        setActiveTrigger(null);
        mobileAnimating = false;
