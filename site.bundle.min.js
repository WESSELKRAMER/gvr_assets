...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!navbar || !megaMenu || !triggers.length || !panels.length || typeof gsap === "undefined") {
    return;
  }
  ...
  function getPanelHeight(panel) {
    ...
    panel.style.display = prevStyles.display;
    panel.style.visibility = prevStyles.visibility;
    panel.style.position = prevStyles.position;
    panel.style.opacity = prevStyles.opacity;
    panel.style.pointerEvents = prevStyles.pointerEvents;
  ...
  function openMobilePanel(key) {
    ...
    const oldPanel = currentPanel;
    const isSamePanel = oldPanel === panel;
    ...
    if (oldPanel) {
      tl.to(oldPanel, {
        ...
        onComplete: () => {
          ...
          oldPanel.style.height = "auto";
          oldPanel.style.overflow = "visible";
        }
      }, 0);
    }
  ...
  function closeMobilePanel() {
    ...
    gsap.to(panelToClose, {
      ...
      onComplete: () => {
        ...
        panelToClose.style.height = "auto";
        panelToClose.style.overflow = "visible";
        currentPanel = null;
        activeKey = null;
        setActiveTrigger(null);
        mobileAnimating = false;
  ...
  window.addEventListener("resize", () => {
    ...
    if (!isMobile()) {
      if (mobileAnimating) mobileAnimating = false;
