document.addEventListener("DOMContentLoaded", () => {
  ...
  "fietsen-wandelen": `
  <svg viewBox="0 0 70 68.92" fill="none" aria-hidden="true">
    <path fill="currentColor" d="M64.74,20.28h-2.32v-4.49c0-4.53-3.68-8.21-8.21-8.21h-10.22v-2.32c0-2.9-2.36-5.26-5.27-5.26h-7.45c-2.9,0-5.27,2.36-5.27,5.26v2.32h-10.22c-4.53,0-8.21,3.68-8.21,8.21v4.49h-2.32c-2.9,0-5.27,2.36-5.27,5.27v13.54c0,2.9,2.36,5.27,5.27,5.27h2.32v16.36c0,4.53,3.68,8.21,8.21,8.21h38.41c4.53,0,8.21-3.68,8.21-8.21v-16.36h2.32c2.9,0,5.26-2.36,5.26-5.26v-13.54c0-2.9-2.36-5.26-5.26-5.26ZM28.78,5.26c0-1.38,1.12-2.5,2.5-2.5h7.45c1.38,0,2.5,1.12,2.5,2.5v2.32h-12.44v-2.32ZM10.35,15.79c0-3,2.44-5.44,5.44-5.44h38.41c3,0,5.44,2.44,5.44,5.44v8.39c0,2.99-2.45,5.42-5.44,5.42h-11.24c-.66-3.81-3.97-6.72-7.97-6.72s-7.31,2.91-7.97,6.72h-11.24c-3,0-5.44-2.44-5.44-5.44v-8.37ZM40.34,30.99c0,2.94-2.4,5.34-5.34,5.34s-5.34-2.4-5.34-5.34,2.4-5.34,5.34-5.34,5.34,2.4,5.34,5.34ZM5.27,41.58c-1.38,0-2.5-1.12-2.5-2.5v-13.54c0-1.38,1.12-2.5,2.5-2.5h2.32v18.54h-2.32ZM54.21,66.15H15.79c-3,0-5.44-2.44-5.44-5.44v-30.44c1.45,1.3,3.35,2.11,5.44,2.11h11.24c.66,3.81,3.97,6.72,7.97,6.72s7.31-2.91,7.97-6.72h11.24c2.1,0,3.99-.81,5.44-2.11v30.44c0,3-2.44,5.44-5.44,5.44ZM67.23,39.08c0,1.38-1.12,2.5-2.5,2.5h-2.32v-18.53h2.32c1.38,0,2.5,1.12,2.5,2.5v13.54Z"/>
    <path fill="currentColor" d="M48.32,45.04h-26.65c-4.02,0-7.3,3.28-7.3,7.3v3.44c0,4.02,3.28,7.3,7.3,7.3h26.65c4.02,0,7.3-3.28,7.3-7.3v-3.44c0-4.02-3.28-7.3-7.3-7.3ZM52.86,55.78c0,2.5-2.03,4.53-4.53,4.53h-26.65c-2.5,0-4.53-2.03-4.53-4.53v-3.44c0-2.5,2.03-4.53,4.53-4.53h26.65c2.5,0,4.53,2.03,4.53,4.53v3.44Z"/>
  </svg>
`,
